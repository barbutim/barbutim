...
public class BishopTest {
    ...
    @Test
    public void AccessibleMoves_WhiteBishopMovesFrom53_WhiteBishopHas6AccessibleMoves() {
        ...
        List<Coordinates> expectedResult = new ArrayList<Coordinates>() {{
            add(new Coordinates(5,3)); add(new Coordinates(4,2)); add(new Coordinates(3,1)); add(new Coordinates(2,0)); add(new Coordinates(6,2));
    ...
    @Test
    public void AccessibleMoves_BlackBishopMovesFrom13_BlackBishopHas5AccessibleMoves() {
        Coordinates coordinates = new Coordinates(1 , 3);
        List<Coordinates> result;
        List<Coordinates> expectedResult = new ArrayList<Coordinates>() {{
            add(new Coordinates(1,3)); add(new Coordinates(0,4)); add(new Coordinates(2,4)); add(new Coordinates(2,2)); add(new Coordinates(3,1));
        }};
