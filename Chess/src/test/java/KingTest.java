...
public class KingTest {
    ...
    @Test
    public void AccessibleMoves_WhiteKingMovesFrom47_WhiteKingHas6AccessibleMoves() {
        ...
        List<Coordinates> expectedResult = new ArrayList<Coordinates>() {{
            add(new Coordinates(4,7)); add(new Coordinates(3,7)); add(new Coordinates(5,7)); add(new Coordinates(6,7)); add(new Coordinates(4,6));
    ...
    @Test
    public void AccessibleMoves_BlackKingMovesFrom40_BlackKingHas6AccessibleMoves() {
        Coordinates coordinates = new Coordinates(4 , 0);
        List<Coordinates> result;
        List<Coordinates> expectedResult = new ArrayList<Coordinates>() {{
            add(new Coordinates(4,0)); add(new Coordinates(3,0)); add(new Coordinates(2,0)); add(new Coordinates(5,0)); add(new Coordinates(3,1));
