...
/**
 * Figures.Rook represents method for figure of rook and his available moves.
 *
 * @author TimotejBarbus
 */
public class Rook extends AbstractFigures {

    /**
     * Constructor for Figures.Rook.
     *
     ...
     */
    public Rook(EnumFiguresType type, EnumFiguresColor color) {
        super(type, color);
    }
