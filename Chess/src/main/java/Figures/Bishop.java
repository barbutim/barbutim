...
/**
 * Figures.Bishop represents method for figure of bishop and his available moves.
 *
 * @author TimotejBarbus
 */
public class Bishop extends AbstractFigures {

    /**
     * Constructor for Figures.Bishop.
     *
     ...
     */
    public Bishop(EnumFiguresType type, EnumFiguresColor color) {
        super(type, color);
    }
